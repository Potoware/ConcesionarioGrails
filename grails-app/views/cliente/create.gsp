    ...
    <body>
        <div class="container pt-5">
            ...
            <div class="nav" role="navigation">
                <g:link class="btn btn-success btn-xs" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link>
            </div>
            <div id="create-cliente" class="content scaffold-create" role="main">
                ...
                <g:form resource="${this.cliente}" method="POST">
                    <fieldset class="form">
                        <f:field bean="cliente" property="nombres"/>
                        <f:field bean="cliente" property="apellidos"/>
                        <f:field bean="cliente" property="identificacion"/>
                        <f:field bean="cliente" property="celular"/>
                        <f:field bean="cliente" property="telefono"/>
                        <f:field bean="cliente" property="fechaNacimiento"/>
                    </fieldset>
