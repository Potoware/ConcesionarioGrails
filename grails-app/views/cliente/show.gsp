    ...
    <body>
        <div class="container pt-5">
            ...
            <div id="show-cliente" class="content scaffold-show" role="main">
                ...
                <f:display bean="cliente" except="inventarios"/>
                <g:form resource="${this.cliente}" method="DELETE">
                <g:link class="btn btn-success btn-xs" action="edit" resource="${this.cliente}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
