    ...
    <body>
        <div class="container pt-5">
            ...
            <div id="show-vendedor" class="content scaffold-show" role="main">
                ...
                <f:display bean="vendedor" except="inventarios"/>
                <g:form resource="${this.vendedor}" method="DELETE">
                <g:link class="btn btn-success btn-xs" action="edit" resource="${this.vendedor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
