    ...
    <body>
        <div class="container pt-5">
            ...
            <div id="show-vehiculo" class="content scaffold-show" role="main">
                ...
                <f:display bean="vehiculo"  except="inventarios"/>
                <g:form resource="${this.vehiculo}" method="DELETE">
                <g:link class="btn btn-success btn-xs" action="edit" resource="${this.vehiculo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
